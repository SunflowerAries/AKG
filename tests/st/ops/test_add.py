...
class TestCase(TestBase):
    ...
    def test_gpu_level0(self):
        return self.run_cases(self.test_args_default, utils.CUDA, "level0")
    
    @pytest.mark.level1
    @pytest.mark.platform_x86_gpu_training
    @pytest.mark.env_onecard
    def test_gpu_level1(self):
        return self.run_cases(self.test_args_default, utils.CUDA, "level1")
    
    @pytest.mark.level0
    @pytest.mark.platform_x86_cpu
    @pytest.mark.env_onecard
    def test_cpu_level0(self):
        return self.run_cases(self.test_args_default, utils.LLVM, "level0")
    
    @pytest.mark.level1
    @pytest.mark.platform_x86_cpu
    @pytest.mark.env_onecard
    def test_cpu_level1(self):
        return self.run_cases(self.test_args_default, utils.LLVM, "level1")
